...
Então, na primeira linha, os especificadores são processados em ordem e realizam uma quebra de linha, um espaçamento tabular com o print da frase e abertura de uma aspas dupla.
